...
public class RegistrationPage extends BaseTest {
	 ...
	 * }
	 * 
	 * public void enterUsernameAndPswdAndConfirmPswdAndClickRegisterBtn(String
	 * username, String password, String confirm_password)
	 * {
	 ...
	 * 
	 * 
	 * public void validateToolTipErrorMsgExcel(String sheetname, int row) throws
	 ...
	 * }
	 * 
	 * public void validateErrorMsgFromExcel(String sheetname, int row) throws
	 * InvalidFormatException, IOException, Exception {
	 * ExcelReader reader = new ExcelReader();
	 * 
	 * List<Map<String, String>> testdata =
