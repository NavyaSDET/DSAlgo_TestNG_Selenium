...
public class QueuePage extends BaseTest {
	...
	public void validateUserIsOnQueueInPythonPage() {
		...
		Assert.assertEquals(getDriver().findElement(implementationOfQueueInPythonPage).getText(),
	...
	public void validateUserIsOnImplementationUsingCollectionsDequePage() {
		...
		Assert.assertEquals(getDriver().findElement(implementaionUsingCollectionDequePage).getText(),
	...
	public void validateUserIsOnImplementationUsingArrayPage() {
		...
		Assert.assertEquals(getDriver().findElement(implementationUsingCollectionsArrayPage).getText(),
