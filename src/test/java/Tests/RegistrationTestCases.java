...
public class RegistrationTestCases extends BaseTest {
	...
	public void TC_01_validate_RegistrationIsSuccessful_onAllValidCredentials()
	...
	public void TC_02_validate_Error_Message_when_DifferentPasswordsIn_Both_PswdFields(String username, String password,
			String confirm_pswd) throws IOException {
	...
	@Test(retryAnalyzer = RetryAnalyzer.class)
	public void the_user_clicks_register_button_after_entering_a_username_with_spacebar_characters_other_than_digits_and_on_registration_form()
			throws IOException {
	...
	@Test(retryAnalyzer = RetryAnalyzer.class)
	public void the_user_clicks_register_button_after_entering_a_password_with_only_numeric_data_on_registration_form()
			throws IOException {
	...
	@Test(retryAnalyzer = RetryAnalyzer.class)
	public void the_user_clicks_register_button_after_entering_a_password_with_characters_less_than_eight_on_registration_form()
			throws IOException {
		RGPage.enterUsername("ologonik27");
